!function t(e, i, n) {
    ...
    3: [function(t, e, i) {
        ...
        e.exports = class {
            ...
            _initializeDirectory(t)
            {
                ...
                this._directory.querySelectorAll(this._selectors.directory + "-column-section").forEach(e => {
                    const i = e.querySelector(this._selectors.directory + "-column-section-title-button"),
                        s = e.querySelector(this._selectors.directory + "-column-section-title-icon"),
                        a = e.querySelector(this._selectors.directory + "-column-section-list");
                    n.create(e, i, s, a, {
            ...
            _initializeLangLink()
            {
                if (this._langLink = this.el.querySelector(this._selectors.mini + "-locale-lang"), !this._langLink)
                    return;
    ...
    5: [function(t, e, i) {
        ...
        class r {
            ...
            onViewportChange(t)
            {
                this._isBreakPointWithMenu(t.viewport) ? (this.button.removeAttribute("disabled"), this.button.setAttribute("aria-expanded", "false"), this.button.setAttribute("aria-controls", this.list.id)) : (this.collapse(), this.button.setAttribute("disabled", ""), this.button.removeAttribute("aria-expanded"), this.button.removeAttribute("aria-controls"))
            }
            destroy()
            {
    ...
    9: [function(t, e, i) {
        ...
        e.exports = class  extends n{
            ...
            _initializeBuyStrip()
            {
                if (this._buystrip = this.el.querySelector(this._selectors.wrapper + "-buystrip"), !this._buystrip)
                    return;
            ...
            _makeBlockLink(t)
            {
                ...
                for (n.className = e.className + " ac-gf-block-link", n.innerHTML = e.innerHTML, e.parentNode.classList.add("with-cta"), e.parentNode.replaceChild(n, e), t.insertBefore(i, t.firstChild); t.childNodes.length > 1;) {
            ...
            _initializeChatLink()
            {
                if (this._chatLink = this._buystrip.querySelector(this._selectors.wrapper + "-buystrip-info-cta-chat"), this._chatLink) {
