!function t(e, i, n) {
    ...
    7: [function(t, e, i) {
        ...
        o.start = function(t) {
            ...
            this._firstTabbableElement ? this.el.contains(document.activeElement) || t || (this._firstTabbableElement.focus(), e = this._firstTabbableElement) : console.warn("this._firstTabbableElement is null, CircularTab needs at least one tabbable element."),
    ...
    8: [function(t, e, i) {
        ...
        s.detect = function(t) {
            ...
            this.isDetecting || (window.ResizeObserver ? (this.resizeObserver = new ResizeObserver(this._onResize), this.resizeObserver.observe(this.span)) : this.iframe.contentWindow.addEventListener("resize", this._onResize), this.isDetecting = !0)
        },
        s._resize = function() {
            this.currentSize = parseFloat(window.getComputedStyle(this.span)["font-size"]),
    ...
    13: [function(t, e, i) {
        ...
        e.exports = function(t) {
            o(t, a),
            o(t, s.HIDDEN);
            for (var e = t.querySelectorAll("[".concat(r + a, "]")), i = e.length; i--;)
                o(e[i], a)
        }
    }, {
        12: 12,
    ...
    14: [function(t, e, i) {
        ...
        e.exports = function t(e, i) {
            i = i || document.body;
            for (var s = e, r = e; s = s.previousElementSibling;)
                n(s);
    ...
    19: [function(t, e, i) {
        ...
        e.exports = {
            parentNode: function(t, e, i) {
                if (i = i || "target", t && !n(t, l))
                    throw new TypeError(e + ": " + i + " must be an Element, or Document Fragment")
            },
            childNode: function(t, e, i) {
                if (i = i || "target", t && !n(t, u))
                    throw new TypeError(e + ": " + i + " must be an Element, TextNode, or Comment")
            },
            insertNode: function(t, e, i) {
                if (i = i || "node", t && !n(t, h))
                    throw new TypeError(e + ": " + i + " must be an Element, TextNode, Comment, or Document Fragment")
            },
    ...
    25: [function(t, e, i) {
        ...
        var n = t(21),
            ...
            _ = function(t, e) {
                ...
                this.stickyEnabled && (this._sticky = new u(this.el, e)),
        ...
        p._initializeMenu = function() {
            ...
            this._updateTrayHidden(),
            this._setCssVars = this._setCssVars.bind(this),
            this._setCssVarsDebounced = this._debounce(this._setCssVars),
            window.addEventListener("resize", this._setCssVarsDebounced)
        },
        p._onMenuOpen = function() {
            this._menuCollapseOnScroll = null,
            this.circTab.start(),
            this.el.classList.add(this._selectors.menuOpenClassName),
            this._transitionsAvailable ? this._disableMenuScrollbar() : this._updateTrayHidden()
        },
        p._onMenuClose = function() {
            this.el.classList.remove(this._selectors.menuOpenClassName),
            this._transitionsAvailable ? (this._disableMenuScrollbar(), this._updateTrayHidden(!0)) : this._updateTrayHidden(),
            this.circTab.stop()
        },
        ...
        p._updateTrayHidden = function(t) {
            if (this.tray) {
                ...
                this.tray[i]("aria-hidden", "true"),
                this.tray[i]("inert", "true")
            }
        },
        p._onTextZoom = function(t) {
            var e = t.detail,
                i = e.currentSize / e.originalSize;
            this.el.classList[1 === i ? "remove" : "add"](this._selectors.textZoomedClassName),
            document.documentElement.style.setProperty("--r-localnav-text-zoom-factor", i)
        },
        p.destroy = function() {
            var t,
                e,
    ...
    26: [function(t, e, i) {
        ...
        o._removeClickClass = function() {
            this.anchorClose.classList.remove(this.clickClass),
            this.anchorOpen.classList.remove(this.clickClass)
        },
        o.destroy = function() {
    ...
    27: [function(t, e, i) {
        ...
        c.destroy = function() {
            this.el.innerHTML = this._originialContents,
            this._shape = null,
    ...
    29: [function(t, e, i) {
        ...
        u._featureDetection = function() {
            var t = "css-sticky";
            s("position", "sticky") && !o || (t = "no-" + t),
            this.el.classList.add(t),
            this.placeholder.classList.add(t)
        },
    ...
    30: [function(t, e, i) {
        ...
        e.exports = function(t) {
            ...
            for (r = s(), i = (t = a(t)).charAt(0).toUpperCase() + t.substring(1), e = "filter" === t ? ["WebkitFilter", "filter"] : (t + " " + o.dom.join(i + " ") + i).split(" "), h = 0; h < e.length; h++)
                if (void 0 !== r.style[e[h]])
                    return 0 !== h && o.reduce(h - 1), c(t, e[h]);
            return c(t, !1)
        }
    }, {
        32: 32,
    ...
    31: [function(t, e, i) {
        ...
        e.exports = function(t, e) {
            ...
            return e += "", !!(t = n(t)) && (s(t, e) ? e : (i = a[t].css, "" !== (e = (e = e.replace(h, (function(e) {
                ...
                if ("#" === e[0] || !isNaN(e[0]))
                    return e;
                if (a = e.replace(c, ""), (h = i + ":" + a) in o)
                    return !1 === o[h] ? "" : e.replace(a, o[h]);
                for (n = r.css.map((function(t) {
                    return t + e
                })), n = [e].concat(n), u = 0; u < n.length; u++)
                    if (s(t, n[u]))
                        return 0 !== u && r.reduce(u - 1), o[h] = n[u].replace(c, ""), n[u];
                return o[h] = !1, ""
            }))).trim()) && e))
        }
    }, {
    ...
    50: [function(t, e, i) {
        ...
        e.exports = function(t, e, i, a) {
            if (s.childNode(t, "ancestors"), s.selector(e, "ancestors"), i && n(t, r) && (!e || t.matches(e)))
                return t;
    ...
    52: [function(t, e, i) {
        ...
        e.exports = {
            ...
            selector: function(t, e, i) {
                if (i = "boolean" == typeof i && i, (t || i) && "string" != typeof t)
    ...
    60: [function(t, e, i) {
        ...
        function r(t, e) {
            ...
            for (var s, r = n.length, a = 0; a < r; a++)
                if ((s = e.match((i = n[a], new RegExp(i + "[a-zA-Z\\s/:]+([0-9_.]+)", "i")))) && s.length > 1)
            ...
            for (var n, s, a = t.length, o = 0; o < a; o++)
                if ("function" == typeof t[o].test ? !0 === t[o].test(i) && (n = t[o].name) : i.ua.indexOf(t[o].userAgent) > -1 && (n = t[o].name), n) {
                    if (e[n] = !0, "string" == typeof (s = r(t[o], i.ua))) {
                        ...
                        "edge" === n && (e.version.string = "12.0.0", e.version.major = "12", e.version.minor = "0", e.version.patch = "0");
