!function e(t, n, r) {
    ...
    2: [function(e, t, n) {
        ...
        u.ONSELECT = "onSelect",
        u.ONFOCUS = "onFocus";
        var h = u.prototype = Object.create(a);
        h._setup = function() {
            for (var e = [c.ARROW_DOWN, c.ARROW_RIGHT], t = [c.ARROW_UP, c.ARROW_LEFT], n = [c.ENTER, c.SPACEBAR], r = 0; r < e.length; r++)
        ...
        h._setTabbingByIndex = function(e) {
            var t = this._navItems[e];
            o(t.getAttribute(this._state)) && (this.focusedNavItemIndex = e, this.selectedNavitemIndex = e),
            o(t.getAttribute(l.DISABLED)) ? r(t) : i(t)
        },
        h.start = function() {
        ...
        h._calculateIndex = function(e, t) {
            var n = t;
            if (!0 === e) {
                if (n = ++n >= this._navItems.length ? 0 : n, !o(this._navItems[n].getAttribute(l.DISABLED)) || this._navItems[n].hasAttribute("disabled"))
                    return n
            } else if (n = --n < 0 ? this._navItems.length - 1 : n, !o(this._navItems[n].getAttribute(l.DISABLED)) || this._navItems[n].hasAttribute("disabled"))
                return n;
        ...
        h.getFocusedItem = function(e) {
            return this._navItems[this.focusedNavItemIndex]
        },
        h.addNavkey = function(e, t) {
            "function" == typeof t && "number" == typeof e ? this._navKeys[e] = t : console.warn("incorrect types arguments were passed")
        },
        h.removeNavkey = function(e) {
            delete this._navKeys[e]
        },
        h.destroy = function() {
            for (var e in a.destroy.call(this), this.stop(), this.el = null, this._options = null, this._selector = null, this.focusedNavItemIndex = null, this.selectedNavitemIndex = null, this._navItems = null, this._state = null, this.selectOption = null, this._handleKeyDown = null, this._navKeys)
    ...
    3: [function(e, t, n) {
        ...
        l._clickProxy = function(e, t, n, r) {
            ...
            o.indexOf(i) < 0 && s("element's role is not set to any of the following " + o.join(", ")),
            r ? (e.removeEventListener("keydown", this._handleKeydown), this._removeCallback(e, t, n)) : (e.addEventListener("keydown", this._handleKeydown), this._addCallback(e, t, n))
        },
        ...
        l._addCallback = function(e, t, n) {
            ...
            this._elements[r] = e,
            n instanceof Function && (this._callbacks[r] = this._callbacks[r] || {}, this._callbacks[r][t] = this._callbacks[r][t] || [], this._callbacks[r][t].push(n))
        },
        l._removeCallback = function(e, t, n) {
            ...
            if (i && i[t]) {
                var o = i[t].indexOf(n);
                i[t].splice(o, 1),
                0 === i[t].length && (delete i[t], this._isEmpty(i) && (delete this._callbacks[r], delete this._elements[r]))
            }
        },
    ...
    4: [function(e, t, n) {
        ...
        o.getTabbableElements = function(e, t) {
            for (var n = e.querySelectorAll(this.focusableSelectors), r = n.length, i = [], o = 0; o < r; o++)
                this.isTabbableElement(n[o], t) && i.push(n[o]);
            return i
        },
        o.getFocusableElements = function(e, t) {
            for (var n = e.querySelectorAll(this.focusableSelectors), r = n.length, i = [], o = 0; o < r; o++)
                this.isFocusableElement(n[o], t) && i.push(n[o]);
            return i
        },
        t.exports = new i
    }, {
    ...
    8: [function(e, t, n) {
        ...
        t.exports = function(e, t, n) {
            ...
            r = e instanceof NodeList ? e : [].concat(e),
            r.forEach(e => {
                e.setAttribute(t, n)
            })
        }
    ...
    13: [function(e, t, n) {
        ...
        t.exports = function(e) {
            ...
            for (t = 0; t < e.length; t += 1)
                r = (r + (n = (n + e.charCodeAt(t)) % 65521)) % 65521;
            return r << 16 | n
        }
    }, {}],
    14: [function(e, t, n) {
    ...
    33: [function(e, t, n) {
        ...
        t.exports = {
            parentNode: function(e, t, n, i) {
                if (i = i || "target", (e || t) && !r(e, u))
                    throw new TypeError(n + ": " + i + " must be an Element, or Document Fragment")
            },
            childNode: function(e, t, n, i) {
                if (i = i || "target", (e || t) && !r(e, c))
                    throw new TypeError(n + ": " + i + " must be an Element, TextNode, or Comment")
            },
            insertNode: function(e, t, n, i) {
                if (i = i || "node", (e || t) && !r(e, l))
                    throw new TypeError(n + ": " + i + " must be an Element, TextNode, Comment, or Document Fragment")
            },
    ...
    73: [function(e, t, n) {
        ...
        t.exports = class {
            constructor(e)
            {
                ...
                for (let t in e)
                    -1 === i.indexOf(t) && "function" != typeof e[t] && (this[t] = e[t]);
    ...
    88: [function(e, t, n) {
        Array.prototype.filter || (Array.prototype.filter = function(e, t) {
            ...
            for (n = 0; n < i; n += 1)
                n in r && e.call(t, r[n], n, r) && o.push(r[n]);
            return o
        })
    }, {}],
    89: [function(e, t, n) {
        ...
        !function() {
            ...
            try {
                ...
                Array.prototype.slice = function(t, n) {
                    if (n = void 0 !== n ? n : this.length, "[object Array]" === Object.prototype.toString.call(this))
    ...
    93: [function(e, t, n) {
        ...
        t.exports = function e(t, n) {
            var l,
                c,
                u;
            if (n = n || "div", t = t.toLowerCase(), n in a || (a[n] = {}), t in (c = a[n]))
                return c[t];
            if (r(t, n))
                return c[t] = t;
            if (t in i)
                for (u = 0; u < i[t].length; u++)
                    if (l = i[t][u], r(l.toLowerCase(), n))
                        return c[t] = l;
            for (u = 0; u < s.evt.length; u++)
                if (l = s.evt[u] + t, r(l, n))
                    return s.reduce(u), c[t] = l;
    ...
    94: [function(e, t, n) {
        ...
        t.exports = function(e) {
            ...
            for (o = i(), n = (e = s(e)).charAt(0).toUpperCase() + e.substring(1), t = "filter" === e ? ["WebkitFilter", "filter"] : (e + " " + a.dom.join(n + " ") + n).split(" "), c = 0; c < t.length; c++)
                if (void 0 !== o.style[t[c]])
                    return 0 !== c && a.reduce(c - 1), l(e, t[c]);
            return l(e, !1)
        }
    }, {
        103: 103,
    ...
    95: [function(e, t, n) {
        ...
        t.exports = function(e, t) {
            ...
            return t += "", !!(e = r(e)) && (i(e, t) ? t : (n = s[e].css, "" !== (t = (t = t.replace(c, (function(t) {
                ...
                if ("#" === t[0] || !isNaN(t[0]))
                    return t;
                if (s = t.replace(l, ""), (c = n + ":" + s) in a)
                    return !1 === a[c] ? "" : t.replace(s, a[c]);
                for (r = o.css.map((function(e) {
                    return e + t
                })), r = [t].concat(r), u = 0; u < r.length; u++)
                    if (i(e, r[u]))
                        return 0 !== u && o.reduce(u - 1), a[c] = r[u].replace(l, ""), r[u];
                return a[c] = !1, ""
            }))).trim()) && t))
        }
    }, {
    ...
    100: [function(e, t, n) {
        ...
        t.exports = function(e, t) {
            ...
            if (function() {
                ...
                return e = o[e].css, CSS.supports(e, t);
            if (n = (l = s()).style[e], i)
                try {
                    l.style[e] = t
                } catch (e) {
    ...
    107: [function(e, t, n) {
        ...
        function a(e) {
            ...
            this._metadata = null,
            this._value = null,
            this.setExpirationDate(a.createExpirationDate(30))
        }
        a.prototype = {
            save: function() {
                var e,
                ...
                if (e = i.best({})) {
                    ...
                    if ("function" == typeof e.setItem)
                        return t = this.__state(), n = s.encode(t), e.setItem(this.key(), n, this.expirationDate())
                }
                return !1
            },
            load: function() {
            ...
            setExpirationDate: function(e) {
                if (null === e && (e = a.createExpirationDate(30)), !1 !== e) {
                    if ("string" == typeof e && (e = new Date(e).getTime()), e && "function" == typeof e.getTime && (e = e.getTime()), !e || isNaN(e))
            ...
            __updateState: function(e) {
                ...
                for (t in null === e && (e = {
                    ...
                    "function" == typeof this[n = "set" + t.charAt(0).toUpperCase() + t.slice(1)] && this[n](e[t])
            },
    ...
    109: [function(e, t, n) {
        ...
        var a = {
            ...
            available: function() {
                try {
                    o.setItem("localStorage", 1),
                    o.removeItem("localStorage")
                } catch (e) {
                    r = !1
                }
    ...
    111: [function(e, t, n) {
        ...
        t.exports = function(e, t) {
            ...
            if (void 0 !== t && "number" != typeof t || (t = void 0 === t ? new Date : new Date(t)), "function" != typeof t.toUTCString || "Invalid Date" === t.toUTCString())
    ...
    121: [function(e, t, n) {
        ...
        function o(e, t) {
            ...
            var n,
                r = e.version || e.userAgent;
            "string" == typeof r && (r = [r]);
            for (var i, o = r.length, s = 0; s < o; s++)
                if ((i = t.match((n = r[s], new RegExp(n + "[a-zA-Z\\s/:]+([0-9_.]+)", "i")))) && i.length > 1)
            ...
            for (var r, i, s = e.length, a = 0; a < s; a++)
                if ("function" == typeof e[a].test ? !0 === e[a].test(n) && (r = e[a].name) : n.ua.indexOf(e[a].userAgent) > -1 && (r = e[a].name), r) {
                    if (t[r] = !0, "string" == typeof (i = o(e[a], n.ua))) {
                        ...
                        "edge" === r && (t.version.string = "12.0.0", t.version.major = "12", t.version.minor = "0", t.version.patch = "0");
    ...
    123: [function(e, t, n) {
        ...
        var r = function(e, t, n, r) {
            ...
            for (var i = t.length - 1, o = 0; o < i; o += 1) {
                if (void 0 !== n && void 0 === e[t[o]])
                    e[t[o]] = {};
                else if (!e.hasOwnProperty(t[o]) || void 0 === e[t[o]])
                    return;
                e = e[t[o]]
            }
            if (void 0 !== n) {
    ...
    130: [function(e, t, n) {
        ...
        l.prototype = {
            ...
            equals: function(e) {
                ...
                for (var n = 0; n < t; n++) {
                    var r = this.opcodes[n],
                        i = e.opcodes[n];
                    if (r.opcode !== i.opcode || !c(r.args, i.args))
                        return !1
                }
            ...
            PartialStatement: function(e) {
                ...
                var n = e.params;
                if (n.length > 1)
                    throw new i.default("Unsupported number of partial arguments: " + n.length, e);
                ...
                this.opcode("invokePartial", o, r, s),
                this.opcode("append")
            },
            ...
            helperSexpr: function(e, t, n) {
                ...
                if (this.options.knownHelpers[a])
                    ...
                    o.falsy = !0,
                    this.accept(o),
                    this.opcode("invokeHelper", r.length, o.original, s.default.helpers.simpleId(o))
                }
            },
    ...
    131: [function(e, t, n) {
        ...
        n.preparePath = function(e, t, n) {
            ...
            for (var r = e ? "@" : "", i = [], s = 0, a = 0, l = t.length; a < l; a++) {
                var c = t[a].part,
                    u = t[a].original !== c;
                if (r += (t[a].separator || "") + c, u || ".." !== c && "." !== c && "this" !== c)
                    i.push(c);
                else {
                    if (i.length > 0)
    ...
    132: [function(e, t, n) {
        ...
        c.prototype = {
            ...
            compile: function(e, t, n, r) {
                ...
                for (l = 0, c = d.length; l < c; l++)
                    d[l] && (h[l] = d[l], f[l] && (h[l + "_d"] = f[l], h.useDecorators = !0));
            ...
            setupParams: function(e, t, n) {
                ...
                for (var h = t; h--;)
                    ...
                    this.stringParams && (o[h] = this.popStack(), i[h] = this.popStack());
        ...
        function() {
            for (var e = "break else new var case finally return void catch for switch while continue function this with default if throw delete in try do instanceof typeof abstract enum int short boolean export interface static byte extends long super char final native synchronized class float package throws const goto private transient debugger implements protected volatile double import public let yield await null true false".split(" "), t = c.RESERVED_WORDS = {}, n = 0, r = e.length; n < r; n++)
                t[e[n]] = !0
        }(),
                    ...
                    parse: function(e) {
                        ...
                        for (var p, d, f, g, m, v, _, y, b, x, w = {};;) {
                            if (f = n[n.length - 1], this.defaultActions[f] ? g = this.defaultActions[f] : (null == p && (x = void 0, "number" != typeof (x = t.lexer.lex() || 1) && (x = t.symbols_[x] || x), p = x), g = o[f] && o[f][p]), void 0 === g || !g.length || !g[0]) {
                                ...
                                if (!c) {
                                    for (v in b = [], o[f])
                                        this.terminals_[v] && v > 2 && b.push("'" + this.terminals_[v] + "'");
                                    k = this.lexer.showPosition ? "Parse error on line " + (a + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + b.join(", ") + ", got '" + (this.terminals_[p] || p) + "'" : "Parse error on line " + (a + 1) + ": Unexpected " + (1 == p ? "end of input" : "'" + (this.terminals_[p] || p) + "'"),
                                    this.parseError(k, {
                            ...
                            case 1:
                                ...
                                n.push(g[1]),
                                p = null,
                                d ? (p = d, d = null) : (l = this.lexer.yyleng, s = this.lexer.yytext, a = this.lexer.yylineno, u = this.lexer.yylloc, c > 0 && c--);
                                break;
                            case 2:
                                ...
                                }, h && (w._$.range = [i[i.length - (_ || 1)].range[0], i[i.length - 1].range[1]]), void 0 !== (m = this.performAction.call(w, s, l, a, this.yy, g[1], r, i)))
                                    return m;
                                _ && (n = n.slice(0, -1 * _ * 2), r = r.slice(0, -1 * _), i = i.slice(0, -1 * _)),
                                n.push(this.productions_[g[1]][0]),
                                r.push(w.$),
                                i.push(w._$),
                                y = o[n[n.length - 2]][n[n.length - 1]],
                                n.push(y);
                                break;
                            case 3:
                                return !0
                ...
                t = function() {
                    var e = {
                        ...
                        performAction: function(e, t, n, r) {
                            ...
                            switch (n) {
                            case 0:
                                if ("\\\\" === t.yytext.slice(-2) ? (i(0, 1), this.begin("mu")) : "\\" === t.yytext.slice(-1) ? (i(0, 1), this.begin("emu")) : this.begin("mu"), t.yytext)
                                    return 15;
                                break;
                            case 1:
                                return 15;
    ...
    134: [function(e, t, n) {
        ...
        s.prototype.SubExpression = function(e) {
            for (var t, n = e.params, r = [], i = 0, o = n.length; i < o; i++)
            ...
            acceptKey: function(e, t) {
                ...
                if (this.mutating) {
                    if (n && !s.prototype[n.type])
                        throw new o.default('Unexpected node type "' + n.type + '" found when accepting ' + t + " on " + e.type);
                    e[t] = n
                }
            },
    ...
    136: [function(e, t, n) {
        ...
        s.prototype.Program = function(e) {
            ...
            for (var r = e.body, i = 0, o = r.length; i < o; i++) {
                ...
                if (h) {
                    ...
                    h.close && c(r, i, !0),
                    h.open && u(r, i, !0),
                    t && m && (c(r, i), u(r, i) && "PartialStatement" === s.type && (s.indent = /([ \t]+$)/.exec(r[i - 1].original)[1])),
                    t && f && (c((s.program || s.inverse).body), u(r, i)),
                    t && g && (c(r, i), u((s.inverse || s.program).body))
                }
            }
            return e
        },
        s.prototype.BlockStatement = s.prototype.DecoratorBlock = s.prototype.PartialBlockStatement = function(e) {
            ...
            if (e.openStrip.close && c(t.body, null, !0), n) {
                ...
                s.close && c(r.body, null, !0),
                e.closeStrip.open && u(i.body, null, !0),
                !this.options.ignoreStandalone && a(t.body) && l(r.body) && (u(t.body), c(r.body))
            } else
    ...
    139: [function(e, t, n) {
        ...
        function i(e, t) {
            ...
            for (var c = Error.prototype.constructor.call(this, e), u = 0; u < r.length; u++)
                this[r[u]] = c[r[u]];
                ...
                n.default = function(e) {
                    e.registerHelper("each", (function(e, t) {
                        ...
                        var n,
                            ...
                            h = void 0;
                        function p(t, n, r) {
                            u && (u.key = t, u.index = n, u.first = 0 === n, u.last = !!r, h && (u.contextPath = h + t)),
                            c += i(e[t], {
                                data: u,
                        ...
                        if (t.data && t.ids && (h = o.appendContextPath(t.data.contextPath, t.ids[0]) + "."), o.isFunction(e) && (e = e.call(this)), t.data && (u = o.createFrame(t.data)), e && "object" == typeof e)
                            if (o.isArray(e))
                                ...
                                for (var f = [], g = e[r.Symbol.iterator](), m = g.next(); !m.done; m = g.next())
                                    f.push(m.value);
    ...
    153: [function(e, t, n) {
            ...
            var r = {
                ...
                invokePartial: function(n, r, o) {
                    ...
                    if (null == l && t.compile && (o.partials[o.name] = t.compile(n, e.compilerOptions, t), l = o.partials[o.name](r, a)), null != l) {
                        if (o.indent) {
                            for (var c = l.split("\n"), u = 0, h = c.length; u < h && (c[u] || u + 1 !== h); u++)
                                c[u] = o.indent + c[u];
                            l = c.join("\n")
                        }
                        return l
        ...
        n.invokePartial = function(e, t, n) {
            ...
            void 0 === e && o && (e = o);
            if (void 0 === e)
                throw new s.default("The partial " + n.name + " could not be found");
        ...
        function f(e, t, n, r, o, s) {
            if (e.decorator) {
                var a = {};
                t = e.decorator(t, a, n, r && r[0], o, s, r),
                i.extend(t, a)
            }
            return t
        }
    ...
    156: [function(e, t, n) {
        var r = e(124).default,
            i = e(134);
        function o(t, n) {
            var i = e(115).readFileSync(n, "utf8");
            t.exports = r.compile(i)
        }
        r.PrintVisitor = i.PrintVisitor,
        r.print = i.print,
        t.exports = r,
        void 0 !== e && e.extensions && (e.extensions[".handlebars"] = o, e.extensions[".hbs"] = o)
    }, {
        115: 115,
        124: 124,
        134: 134
        ...
        (function(e) {
            (function() {
                !function(e) {
                    ...
                    r.list = p(r.list).replace(/bull/g, r.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + r.def.source + ")").getRegex(),
                    ...
                    r.html = p(r.html).replace("comment", /<!--[\s\S]*?-->/).replace("closed", /<(tag)[\s\S]+?<\/\1>/).replace("closing", /<tag(?:"[^"]*"|'[^']*'|\s[^'"\/>\s]*)*?\/?>/).replace(/tag/g, r._tag).getRegex(),
                    r.paragraph = p(r.paragraph).replace("hr", r.hr).replace("heading", r.heading).replace("lheading", r.lheading).replace("tag", "<" + r._tag).getRegex(),
                    ...
                    r.gfm.paragraph = p(r.paragraph).replace("(?!", "(?!" + r.gfm.fences.source.replace("\\1", "\\2") + "|" + r.list.source.replace("\\1", "\\3") + "|").getRegex(),
                    r.tables = v({}, r.gfm, {
                        nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
                        table: /^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/
                    }),
                        ...
                        for (e = e.replace(/^ +$/gm, ""); e;)
                            if ((o = this.rules.newline.exec(e)) && (e = e.substring(o[0].length), o[0].length > 1 && this.tokens.push({
                                ...
                                for (e = e.substring(o[0].length), l = {
                                    ...
                                    cells: o[3].replace(/\n$/, "").split("\n")
                                }, u = 0; u < l.align.length; u++)
                                    /^ *-+: *$/.test(l.align[u]) ? l.align[u] = "right" : /^ *:-+: *$/.test(l.align[u]) ? l.align[u] = "center" : /^ *:-+ *$/.test(l.align[u]) ? l.align[u] = "left" : l.align[u] = null;
                                ...
                                for (e = e.substring(o[0].length), d = (s = o[2]).length > 1, this.tokens.push({
                                    ...
                                    ordered: d,
                                    start: d ? +s : ""
                                }), n = !1, p = (o = o[0].match(this.rules.item)).length, u = 0; u < p; u++)
                                    c = (l = o[u]).length,
                                    ~(l = l.replace(/^ *([*+-]|\d+\.) +/, "")).indexOf("\n ") && (c -= l.length, l = this.options.pedantic ? l.replace(/^ {1,4}/gm, "") : l.replace(new RegExp("^ {1," + c + "}", "gm"), "")),
                                    this.options.smartLists && u !== p - 1 && (s === (a = r.bullet.exec(o[u + 1])[0]) || s.length > 1 && a.length > 1 || (e = o.slice(u + 1).join("\n") + e, u = p - 1)),
                                    i = n || /\n\n(?!\s*$)/.test(l),
                                    u !== p - 1 && (n = "\n" === l.charAt(l.length - 1), i || (i = n)),
                                    this.tokens.push({
                                ...
                                for (e = e.substring(o[0].length), l = {
                                    ...
                                    /^ *-+: *$/.test(l.align[u]) ? l.align[u] = "right" : /^ *:-+: *$/.test(l.align[u]) ? l.align[u] = "center" : /^ *:-+ *$/.test(l.align[u]) ? l.align[u] = "left" : l.align[u] = null;
                                for (u = 0; u < l.cells.length; u++)
                                    l.cells[u] = l.cells[u].replace(/^ *\| *| *\| *$/g, "").split(/ *\| */);
                                this.tokens.push(l)
                    ...
                    function s(e, t) {
                        if (this.options = t || _.defaults, this.links = e, this.rules = o.normal, this.renderer = this.options.renderer || new a, this.renderer.options = this.options, !this.links)
                    ...
                    o.link = p(o.link).replace("inside", o._inside).replace("href", o._href).getRegex(),
                    o.reflink = p(o.reflink).replace("inside", o._inside).getRegex(),
                    o.normal = v({}, o),
                    ...
                    s.prototype.output = function(e) {
                        for (var t, n, r, i, o = ""; e;)
                            if (i = this.rules.escape.exec(e))
                                ...
                                e = e.substring(i[0].length),
                                "@" === i[2] ? r = "mailto:" + (n = u(i[0])) : (n = u(i[0]), r = "www." === i[1] ? "http://" + n : n),
                                o += this.renderer.link(r, null, n);
                        return o
                    },
                    ...
                    c.prototype.parse = function(e) {
                        ...
                        this.inlineText = new s(e.links, v({}, this.options, {
                            renderer: new l
                        })),
                    ...
                    c.prototype.tok = function() {
                        ...
                        case "list_start":
                            o = "";
                            for (var s = this.token.ordered, a = this.token.start; "list_end" !== this.next().type;)
                                o += this.tok();
                    ...
                    function _(e, t, n) {
                        ...
                        if (n || "function" == typeof t) {
                            ...
                            try {
                                ...
                                if (e.message += "\nPlease report this to https://github.com/markedjs/marked.", (t || _.defaults).silent)
                    ...
                    _.lexer = i.lex,
                    _.InlineLexer = s,
                    _.inlineLexer = s.output,
                    _.parse = _,
                    void 0 !== t && "object" == typeof n ? t.exports = _ : "function" == typeof define && define.amd ? define((function() {
                        return _
                    })) : e.marked = _
    ...
    166: [function(e, t, n) {
        ...
        c.fromSourceMap = function(e, t) {
            ...
            for (var l = e._mappings.toArray().slice(), h = n.__generatedMappings = [], p = n.__originalMappings = [], d = 0, f = l.length; d < f; d++) {
                ...
                g.source && (m.source = s.indexOf(g.source), m.originalLine = g.originalLine, m.originalColumn = g.originalColumn, g.name && (m.name = i.indexOf(g.name)), p.push(m)),
                h.push(m)
            }
        ...
        c.prototype._parseMappings = function(e, t) {
            for (var n, i, o, l, c, h = 1, p = 0, d = 0, f = 0, g = 0, m = 0, v = e.length, _ = 0, y = {}, b = {}, x = [], w = []; _ < v;)
                if (";" === e.charAt(_))
                    ...
                    p = n.generatedColumn,
                    o.length > 1 && (n.source = g + o[1], g += o[1], n.originalLine = d + o[2], d = n.originalLine, n.originalLine += 1, n.originalColumn = f + o[3], f = n.originalColumn, o.length > 4 && (n.name = m + o[4], m += o[4])),
                    w.push(n),
        ...
        h.prototype._parseMappings = function(e, t) {
            ...
            for (var n = 0; n < this._sections.length; n++)
                for (var i = this._sections[n], o = i.consumer._generatedMappings, s = 0; s < o.length; s++) {
                    ...
                    c = r.computeSourceURL(i.consumer.sourceRoot, c, this._sourceMapURL),
                    this._sources.add(c),
        ...
        a.prototype._serializeMappings = function() {
            for (var e, t, n, o, s = 0, a = 1, l = 0, c = 0, u = 0, h = 0, p = "", d = this._mappings.toArray(), f = 0, g = d.length; f < g; f++) {
                if (e = "", (t = d[f]).generatedLine !== a)
                    ...
                    if (!i.compareByGeneratedPositionsInflated(t, d[f - 1]))
                        continue;
                    e += ","
                }
                e += r.encode(t.generatedColumn - s),
                s = t.generatedColumn,
                null != t.source && (o = this._sources.indexOf(t.source), e += r.encode(o - h), h = o, e += r.encode(t.originalLine - 1 - c), c = t.originalLine - 1, e += r.encode(t.originalColumn - l), l = t.originalColumn, null != t.name && (n = this._names.indexOf(t.name), e += r.encode(n - u), u = n)),
                p += e
            }
            return p
        },
    ...
    168: [function(e, t, n) {
        var r = e(167).SourceMapGenerator,
            i = e(169),
            o = /(\r?\n)/,
            s = "$$$isSourceNode$$$";
        ...
        a.prototype.toStringWithSourceMap = function(e) {
            ...
            return this.walk((function(e, r) {
                t.code += e,
                null !== r.source && null !== r.line && null !== r.column ? (o === r.source && s === r.line && a === r.column && l === r.name || n.addMapping({
                    source: r.source,
                    original: {
                        line: r.line,
                        column: r.column
                ...
                for (var c = 0, u = e.length; c < u; c++)
                    10 === e.charCodeAt(c) ? (t.line++, t.column = 0, c + 1 === u ? (o = null, i = !1) : i && n.addMapping({
                        source: r.source,
                        original: {
                            line: r.line,
                            column: r.column
    ...
    169: [function(e, t, n) {
        ...
        function a(e) {
            ...
            for (var i, a = n.isAbsolute(t), l = t.split(/\/+/), c = 0, u = l.length - 1; u >= 0; u--)
                "." === (i = l[u]) ? l.splice(u, 1) : ".." === i ? c++ : c > 0 && ("" === i ? (l.splice(u + 1, c), c = 0) : (l.splice(u, 2), c--));
    ...
    170: [function(e, t, n) {
        n.SourceMapGenerator = e(167).SourceMapGenerator,
        n.SourceMapConsumer = e(166).SourceMapConsumer,
        n.SourceNode = e(168).SourceNode
    }, {
        166: 166,
        167: 167,
        168: 168
    ...
    173: [function(e, t, n) {
        ...
        const i = e(44).EventEmitterMicro,
            o = e(2),
            s = e(72),
            a = e(75),
            l = e(117),
        ...
        t.exports = class {
            ...
            {
                let e = {};
                e.optOutDismissalMax = parseInt(this._jsonData.localeswitcher.exit.metadata.dismiss),
                e.optOutDaysToExpiration = parseInt(this._jsonData.localeswitcher.exit.metadata.duration),
                this._options = Object.assign(m, e)
            }
            _addStyleSheet()
            {
                let e = this._getAcFilePath(this._userLangLocale) + this._options.fluidStyleSheetFilePath;
                const t = document.createElement("link");
                t.rel = "stylesheet",
                t.type = "text/css",
                t.href = e,
                t.addEventListener("load", this._loadStylesComplete.bind(this)),
            ...
            _addLocaleSwitcherContent()
            {
                const e = p.compile(f)(this._jsonData);
            ...
            _initialize()
            {
                if (this._selectIsOpen = !1, this._selectors = {
                    ...
                    document.querySelectorAll(this._options.closeElementsQuery).forEach(e => {
                        e.addEventListener("click", this._handleCloseBarEvent, {
                            signal: this._menuExpandCloseController.signal
                        })
                    })
                }
                const e = document.querySelector("[hreflang=en-US]");
                e && ("https://www.apple.com/" === e.href || null !== e.href.match(/.com\/$/im)) && document.documentElement.classList.toggle(this._selectors.fixedClass)
            }
            _setUpEventListeners()
            {
                ...
                this._closeButton.addEventListener("click", this._handleCloseBarEvent),
                this._closeButton.addEventListener("keydown", this._handleCloseBarKeyDownEvent.bind(this)),
                this._continueButton.addEventListener("click", this._handleContinueButtonEvent.bind(this)),
                this._initializeDropdownToggle()
            }
            _getUserBrowserLanguage()
            {
            ...
            _hasOptedOut()
            {
                ...
                if (l()) {
                    ...
                    const t = this.storageItem.value();
            ...
            _createLocalStorage()
            {
                ...
                this.storageItemExpiration = c.createExpirationDate(this._options.optOutDaysToExpiration),
                this.storageItem.setExpirationDate(this.storageItemExpiration),
                this.storageItem.save()
            }
            _removeExpiredLocalStorage()
            {
                const e = this.storageItem.expirationDate();
            ...
            _setOptOutCounter()
            {
                var e,
                    t;
                const n = null === (e = this.storageItem) || void 0 === e || null === (t = e.value()) || void 0 === t ? void 0 : t.dismissals;
                n < this._options.optOutDismissalMax && (this.storageItem.setValue({
                    dismissals: n + 1
                }), this.storageItem.save())
            }
            _localeLanguageInHrefLangDoesNotExist()
            {
                return !document.querySelector("[hreflang=" + this._userLangLocale + "]")
            }
            _userLanglocaleMatchesCurrentLocale()
            {
                return document.documentElement.getAttribute("lang") === this._userLangLocale
            }
            _segmentBarVisible()
            {
                return document.documentElement.classList.contains("globalmessage-segment-visible")
            }
            _setPageTrackingData(e)
            {
            ...
            _shouldInitializeLocaleSwitcher()
            {
            ...
            _initializeDropdownToggle()
            {
                this._arrowNavigation = new o(this._dropdownList, {
                    selector: "li",
                    state: "data-ac-ls-selected"
                }),
                this._dropdownWrapperKeyboard = new s(this._dropdownList.parentElement),
                u(this._selectTrigger),
                this._arrowNavigation.start(),
                h.addEventListener(this._selectTrigger, "click", this._openDropdown),
                this._dropdownWrapperKeyboard.onUp(a.ARROW_UP, this._openDropdown),
                this._dropdownWrapperKeyboard.onUp(a.ARROW_DOWN, this._openDropdown),
                this._dropdownWrapperKeyboard.onUp(a.ESCAPE, this._closeDropdown),
                this._arrowNavigation.on("onSelect", this._handleDropdownSelection),
                this._dropdownFirstItemKeyboard = new s(this._firstFocusableMenuEl),
                this._dropdownLastItemKeyboard = new s(this._lastFocusableMenuEl),
                this._dropdownFirstItemKeyboard.onDown(a.TAB, this._dropdownFocusOut),
                this._dropdownLastItemKeyboard.onDown(a.TAB, this._dropdownFocusOut)
            }
            _handleDropdownSelection(e)
            {
                if (e.el.classList.contains(this._selectors.dropdownOptionClass)) {
                    document.getElementById("ac-ls-dropdown-title").innerHTML = e.el.innerHTML
                }
            ...
            _setDropdownLinks()
            {
                let e = this._findCountryMatches(this._geoCookieLocale);
                ...
                e.forEach((e, t) => {
                    const n = document.querySelector(`[hreflang=${e}]`).href;
            ...
            _sortLinkIds(e, t)
            {
                ...
                if (-1 !== n && e.length > 1) {
                    const t = [];
                    return t[0] = e[n], e.splice(n, 1), t[1] = e[0], t
                }
                return e
            }
            _setContinueButton(e)
            {
                const t = e.getAttribute("data-href");
                this._selectedLink = t;
                const n = document.querySelector(`[href$="${t}"][hreflang]`);
                this._selectedCountry = "choose your country",
                n && (this._selectedCountry = n.hreflang),
                this._continueButton.setAttribute("href", t)
            }
            _onRAFUpdate()
            {
            ...
            _onRAFDraw()
            {
                this._elHeight !== this._lastHeight && (document.documentElement.style["margin-top"] = this._elHeight, this.el.style.top = "-" + this._elHeight),
                this._lastHeight = this._elHeight
            }
            _determineAnalyticsEvents()
            {
                let e;
                this._listItems.forEach((t, n) => {
                    this._listItems[n].getAttribute("data-href") === this._selectedLink && (e = n)
                });
                let t = "event142";
                return 0 === e ? t = "event141" : e === this._listItems.length - 1 && (t = "event143"), t
            }
            _handleContinueButtonEvent(e)
            {
                e.preventDefault();
                const t = "event144, " + this._determineAnalyticsEvents();
                if (r) {
                    new r(this._eventEmitterMicro).track({
            ...
            _handleCloseBarEvent()
            {
                ...
                this._dispatchWindowEvent("close"),
                document.documentElement.style["margin-top"] = "",
                this.el.style.top = "",
                ...
                this._menuExpandCloseController && this._menuExpandCloseController.abort(),
            ...
            _handleCloseBarKeyDownEvent(e)
            {
                const t = e.currentTarget;
                if (document.activeElement === t && ("Enter" === e.code || "Space" === e.code)) {
                    const e = g.getFocusableElements(document.body, !0).filter(e => !0 !== this.el.contains(e));
                    e.length > 0 && (this.focusedElementsId = setTimeout(() => {
                        e[0].focus(),
                        clearTimeout(this.focusedElementsId)
                    }, this._options.focusedElementsTimeout))
                }
            }
            _handleDropdownClickAway(e)
            {
                var t;
                const n = this._dropdownList.parentElement,
                    r = n.contains(e.target),
                    i = n.classList.contains(this._selectors.dropdownCollapsedClass),
                    o = e.target.classList.contains("globalnav-link-search") || (null === (t = e.target.parentElement) || void 0 === t ? void 0 : t.classList.contains("globalnav-searchfield-wrapper"));
                r || i ? r || !i || o || "click" !== e.type ? r || !i || o || "touchstart" !== e.type || document.activeElement.blur() : document.body.focus() : this._closeDropdown()
            }
            _openDropdown(e)
            {
                this._selectIsOpen || (e.preventDefault(), e.stopPropagation(), this._dropdownList.parentElement.classList.remove(this._selectors.dropdownCollapsedClass), this._dropdownList.querySelector("[data-ac-ls-selected=true]").focus(), this._selectTrigger.removeAttribute("tabindex"), this._selectTrigger.setAttribute("aria-expanded", "true"), this._selectIsOpen = !0)
            }
            _closeDropdown()
            {
                this._selectIsOpen && (this._dropdownList.parentElement.classList.add(this._selectors.dropdownCollapsedClass), u(this._selectTrigger), this._selectTrigger.removeAttribute("aria-expanded"), this._selectTrigger.focus(), this._selectIsOpen = !1)
            }
            _dropdownFocusOut(e)
            {
                e.currentTarget === this._firstFocusableMenuEl && !0 === e.shiftKey && (e.stopPropagation(), e.preventDefault(), this._closeDropdown()),
                e.currentTarget === this._lastFocusableMenuEl && !1 === e.shiftKey && (e.stopPropagation(), e.preventDefault(), this._closeDropdown(), this._continueButton.focus())
            }
            _getCookie(e)
            {
            ...
            _getLocaleCode(e, t)
            {
                let n = [],
                    r = null;
                return n = this._findCountryMatches(e), r = this._findLanguageMatches(n, t), r
            }
            _findCountryMatches(e)
            {
                const t = [];
                return document.querySelectorAll("[hreflang]").forEach(n => {
                    const r = n.hreflang,
                        i = n.hreflang.split("-")[1];
                    e === i && t.push(r)
                }), t
            }
            _findLanguageMatches(e, t)
            {
                let n = e[0];
                return e.length > 1 && e.forEach(e => {
                    const r = e.split("-")[0];
                    t === r && (n = e)
                }), n
            }
            _getParameterByName(e, t)
            {
