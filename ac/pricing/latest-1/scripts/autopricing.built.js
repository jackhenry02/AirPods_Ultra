    ...
    return function(t) {
        ...
        for (let e = 0, i = n.length; e < i; e++) {
            ...
            o && (t.exports[i] = function() {
                ...
                a || "string" != typeof t[0] || (t[0] = `${s} ${t[0]}`),
                "group" !== i && "groupCollapsed" !== i || (a = !0),
                "groupEnd" === i && (a = !1),
                o.apply(r, t)
            })
        }
        ...
        t.exports = function(t) {
            return new Promise(e => {
                "undefined" != typeof window && window.document ? r(() => {
                    const i = {};
                    s(t) && (i.endpoint = (s(t).getAttribute("href") || "").trim()),
                    n(t, i),
                    a(t, i);
                    const r = document.querySelector('meta[name="ac:pricing-dummy"]');
                    r && (i.dummyPrices = "true" === (r.getAttribute("content") || "").trim()),
                    e(i)
                }) : e({})
            })
        }
        ...
        const r = i(9),
            ...
            a = t => ({
                ...
                "price.display.instantCashBack": t.isOptionalBoolean,
                "price.display.installmentType": t.isOptionalString,
                ...
                "supportedWaysToBuy.fullprice": t.isOptionalBoolean,
                "supportedWaysToBuy.citizens": t.isOptionalBoolean,
                "supportedWaysToBuy.applecardinstallments": t.isOptionalBoolean
            }),
            o = (t="id") => e => void 0 === e || s(e, e => ({
                ...
                "priceWithCreditApplied.display.from": e.isOptionalString,
        ...
        class u {
            ...
            {
                if (!u.validate(t))
                    throw new n("Could not create Product, because the given JSON contains invalid data.");
                r(this, t)
            }
            get isWUIP()
            {
        ...
        t.exports = class  extends Error{
            constructor(t)
            {
                super(t || "Failed to fetch product price: The API service responded with an unexpected data format."),
        ...
        class c {
            ...
            {
                if (!c.validate(t))
                    throw new n("Could not create TradeIn, because the given JSON contains invalid data.");
                r(this, t)
            }
            static validate(t)
            {
                ...
                if (!r) {
                    const r = t.switch,
                        s = {
                            ...function(t, e) {
                                if (t.aliases)
                                    return i(t.aliases, e)
                            }(t, r),
                            ...function(t, e, r) {
                                if (!e.aliases) {
                                    return i(t.reduce((t, e) => ({
                                        ...t,
                                        [e]: e
                                    }), {}), r)
                                }
                                const s = Object.keys(e.aliases);
                                return i(t.filter(t => !s.includes(t)).reduce((t, e) => ({
                                    ...t,
                                    [e]: e
                                }), {}), r)
                            }(e, t, r)
        ...
        const n = {
            ...
            isOptionalBoolean: t => "boolean" == typeof t || null == t
        };
        function a(t, e) {
        ...
        t.exports = function(t, e) {
            ...
            for (let e = 0, s = i.length; e < s; e++) {
                const [s, n] = i[e],
                    o = s.indexOf(".") > -1 ? a(t, s) : t[s];
                if (!0 !== n.call(t, o, t))
                    return r.error(`Schema property "${s}" does not match response.`), !1
            }
            return !0
        }
    }, function(t, e, i) {
        ...
        t.exports = function(t=[], e={}) {
            ...
            return r("edupricing").then(i => {
                if (o() && (i.dummyPrices = !o(), e.dummyPrices = !o()), i.switch) {
                    const e = a(i, t);
                    t = e
                }
                if (e.switch) {
        ...
        t.exports = class  extends n{
            ...
            {
                let i = null;
                if (this.options.dummyPrices && "UNKNOWN" === e.type && (e = r(t, "unknown"), this.itemsWithDummyPrice.push(t)), i = new s(e), !i.price || 0 !== i.price.value)
                    return i.price && 999999 === i.price.value && this.itemsWithDummyPrice.push(t), i
            }
        ...
        t.exports = class {
            ...
            loggData(t)
            {
                n.group("%cResults from Apple Online Store", "background-color:#27a33f;color:white;padding:2px 5px"),
                n.log(t),
                n.groupEnd(),
                n.enabled && this.itemsWithDummyPrice.length && (n.group("Dummy Prices"), n.warn("Using dummy prices for the following product identifiers: " + this.itemsWithDummyPrice.join(", ")), n.info("$777,777 — The API service may require authentication and/or authorization. \n$888,888 — The product identifer is currently unknown to the API service. \n$999,999 — The product identifier is known to the API service, but the price has yet to be set. \n$111,111 — The referenced optional field was not provided in the API response. \n"), n.groupEnd())
            }
            ...
            _processOptions(t)
            {
                if (!(t = Object.assign({}, u, t)).endpoint)
            ...
            _processResponse(t)
            {
                ...
                case 200:
                    if (i = a(t.responseText), null !== i && (e = this.getItemsFromResponse(i), e))
                        return e;
                default:
            ...
            _request()
            {
                return new Promise((t, e) => {
                    ...
                    i.ontimeout = e.bind(this, new o.TimeoutError(this.options.timeout)),
                    i.onerror = e.bind(this, new o.UnexpectedError),
                    i.open(this.options.method, s(this.options.endpoint, this.identifierParam, this.ids), !0),
        ...
        r.loadEduPricingFromHTML().then(t => s("edupricing")(t)),
        r.loadPricingFromHTML().then(t => s("pricing")(t)),
        r.loadTradeInFromHTML().then(t => s("tradein")(t))
    }, function(t, e, i) {
        "use strict";
        t.exports = Object.assign({
            applyPrices: i(26),
            fetchEduProducts: i(12),
            fetchProducts: i(21),
            fetchTradeIns: i(22),
            Product: i(4),
            TradeIn: i(6)
        ...
        const r = i(4),
            s = i(6),
            n = r.getProductSchema,
            a = s.getTradeInSchema,
            o = i(12),
            c = i(21),
            u = i(22),
            h = i(2),
            ...
            p = "Hide",
            d = "HideAll",
            m = "MultipleElementsToHide",
            f = "Product",
            b = "SingleElementsToHide",
            _ = {
                isOptionalString: Symbol("OPTIONAL_STRING"),
                isOptionalBoolean: Symbol("OPTIONAL_BOOLEAN")
            },
            g = new Set(Object.values(_)),
            y = n(_),
            x = new Set(Object.entries(y).filter(([t, e]) => g.has(e)).map(([t]) => t)),
            F = a("id")(_),
            w = new Set(Object.entries(F).filter(([t, e]) => g.has(e)).map(([t]) => t)),
            S = "edupricing",
            P = "pricing",
            E = "tradein";
        t.exports = new class {
            ...
            fetchProductInfo(t, e={})
            {
                let i,
                    r;
                const s = this.getProductID(t, this[`${t}${l}`]);
                return h(t).then(n => {
                    const a = Object.assign({}, n, e);
                    return t === P ? r = c(s, e) : t === S ? r = o(s, e) : t === E ? r = u(s, e) : i = "API not supported", i || r.then(t => ({
                        response: t,
                        options: a
                    }))
                })
            ...
            {
                this[`${e}${m}`].forEach(i => {
                    const r = i.dataset[`${e}${d}`].split(",").every(e => !t.products[e] || this.checkForProductNameKey(t.products[e], t.products[e].productName) || this.checkForTypeKey(t.products[e], t.products[e].type));
            ...
            handleProductInfo(t, e, i, r)
            {
                if (i.error && !r.dummyPrices)
                    return this.handleError(e, i, t);
                const s = i.products && i.products[this.getproductID(e, t)] || {},
                    n = e.dataset.productTemplate || "";
                let a = !1;
                const o = this.getOptionalFields(t),
                    c = n.replace(/\$\{\s*([\w\d.]+)\s*\}/g, (t, e) => {
                        const i = this.getValueFromPath(t, s);
                        return i || (r.dummyPrices && o.has(e) ? "$111,111" : (a = !0, ""))
                    });
                if (a)
                    return this.handleError(e, i, t);
                e.textContent = c,
                e.dataset.pricingLoaded = "",
                e.parentElement.classList.add("has-dynamic-content")
            }
            handleError(t, e, i)
            {
                this.getSingleElementToHide(i),
                this.hideSingleElements(t, e, i),
                this.getMultipleElementsToHide(i),
                this.hideMultipleElements(e, i),
            ...
            fetchProductDataFromHTML(t, e)
            {
                return new Promise(i => {
                    this.setElements(t),
                    this.fetchProductInfo(t, e).then(({response: e, options: r}) => {
                        e && (this[`${t}${l}`].forEach(i => this.handleProductInfo(t, i, e, r)), i(e.error))
                    }).catch(t => {
                        throw t
                    })
                })
            ...
            {
                return this.fetchProductDataFromHTML(S, t)
            }
            ...
            {
                return this.fetchProductDataFromHTML(E, t)
            }
        }
    }, function(t, e, i) {
        "use strict";
        ...
        n.cancelAnimationFrame = function(t) {
            ...
            this._cancelFrameIdx > -1 ? this._cancelNextAnimationFrame() : (this._cancelFrameIdx = this._currentFrameCallbacks.indexOf(t), this._cancelFrameIdx > -1 ? this._cancelCurrentAnimationFrame() : (this._cancelFrameIdx = this._frameCallbacks.indexOf(t), this._cancelFrameIdx > -1 && this._cancelRunningAnimationFrame()))
        },
        ...
        r._onAnimationFrameStart = function(t) {
            this._isRunning = !0,
            this._willRun = !1,
            this._didEmitFrameData || (this._didEmitFrameData = !0, this.trigger("start", t))
        },
        ...
        "use strict";
        t.exports = {
            EventEmitterMicro: i(13)
        }
    }, function(t, e, i) {
        "use strict";
        var r = i(14).SharedInstance,
            s = i(15).majorVersionNumber,
            n = i(54);
            ...
            return {
                ...
                price: {
                    ...
                    display: {
                        ...
                        apr: a + "%",
                        instantCashBack: !0,
                        installmentType: "Full $" + a
                    }
                },
                supportedWaysToBuy: {
                    fullprice: !0,
                    citizens: !0,
                    applecardinstallments: !0
                }
            }
        }
    }, function(t, e, i) {
        ...
        t.exports = class  extends Error{
            ...
            {
                let e;
                "endpoint" === t.type && (e = "Failed to fetch product prices: The API service endpoint was not specified."),
                super(e),
        ...
        t.exports = class  extends Error{
            ...
            {
                r.warn(this.message),
                r.info('Check the "href" value of the %c<link rel="ac:pricing-endpoint">%c tag or the "fetchProducts" function\'s "endpoint" option, if specified.', "font-family:monospace", "")
            }
        }
    }, function(t, e, i) {
        "use strict";
        ...
        t.exports = class  extends Error{
            constructor(t)
            {
                super("Failed to fetch product prices: The API service did not respond within " + t + " seconds, so the request was aborted."),
        ...
        t.exports = class  extends Error{
            ...
            {
                r.warn(this.message),
                r.info("The API service endpoint may require authentication and/or authorization.")
            }
        }
    }, function(t, e, i) {
        "use strict";
        ...
        t.exports = class  extends s{
            ...
            {
                let i = null;
                if (this.options.dummyPrices && "UNKNOWN" === e.productName && (e = r(t, "unknown"), this.itemsWithDummyPrice.push(t)), i = new n(e), !i.credit || 0 !== i.credit.value)
                    return i.credit && 999999 === i.credit.value && this.itemsWithDummyPrice.push(t), i
            }
            getItemsFromResponse(t)
            {
                return t.ids
